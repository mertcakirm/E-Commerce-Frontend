              ...
              <div className="sss-card">
                <div className="sss-card-baslik">
                  <svg
                    ...
                    clipRule="evenodd"
                  >
                    <path d="M12 24c-.553 0-1-.447-1-1 0-.553.447-1 1-1h5v-3h-1c-.553 0-1-.447-1-1s.447-1 1-1h1v-2h-1c-.553 0-1-.447-1-1s.447-1 1-1h1v-2h-1c-.553 0-1-.447-1-1s.447-1 1-1h1v-2h-5c0 .553-.447 1-1 1-.553 0-1-.447-1-1s.447-1 1-1h6c.553 0 1 .447 1 1v2h1c.553 0 1 .447 1 1s-.447 1-1 1h-1v2h1c.553 0 1 .447 1 1s-.447 1-1 1h-1v2h1c.553 0 1 .447 1 1s-.447 1-1 1h-1v3h1c.553 0 1 .447 1 1s-.447 1-1 1h-6zm-2-13h-3v3h3v-3zm1-2v7h-5v-7h5zm-2-3c-.553 0-1-.447-1-1v-2c0-.553.447-1 1-1s1 .447 1 1v2c0 .553-.447 1-1 1zm2-5h-5c0 .553-.447 1-1 1-.553 0-1-.447-1-1s.447-1 1-1h6c.553 0 1 .447 1 1s-.447 1-1 1zm-2 5h-3v3h3v-3zm-5 4h-5c0 .553-.447 1-1 1-.553 0-1-.447-1-1s.447-1 1-1h6c.553 0 1 .447 1 1s-.447 1-1 1z" />
                  </svg>
                  <p>ÜYELİK</p>
                </div>
                <button
              ...
              <div className="sss-card">
                <div className="sss-card-baslik">
                  <svg
                    ...
                    clipRule="evenodd"
                  >
                    <path d="M17 16v-7h-10v7h10zm0-10v-3h-10v3h10zm2-6c1.105 0 2 .895 2 2v16c0 1.105-.895 2-2 2h-14c-1.105 0-2-.895-2-2v-16c0-1.105.895-2 2-2h14zm0 2h-14v16h14v-16zm-10 18h6v1h-6v-1z" />
                  </svg>
                  <p>DİĞER</p>
                </div>
                <button
