      ...
      <div className="row">
        <div className="col-lg-6">
          ...
          <div className="categori-card">
            <img src="https://cdn.aksesuarix.com/Fotograflar/88114-tee.jpg" className="w-100 img-fluid" alt="" />
        ...
        <a href="#">
          ...
          <div className="categori-card">
            <img src="https://cdn.aksesuarix.com/Fotograflar/88115-sort.jpg" className="w-100 img-fluid" alt="" />
            <div className="categori-card-child">
        ...
        <a href="#">
          ...
          <div className="categori-card">
            <img src="https://cdn.aksesuarix.com/Fotograflar/88116-pant.jpg" className="w-100 img-fluid" alt="" />
            <div className="categori-card-child">
        ...
        <a href="#">
          ...
          <div className="categori-card">
            <img src="https://cdn.aksesuarix.com/Fotograflar/88119-go-n.jpg" className="w-100 img-fluid" alt="" />
            <div className="categori-card-child">
        ...
        <a href="#">
          ...
          <div className="categori-card">
            <img src="https://cdn.aksesuarix.com/Fotograflar/88118-esof.jpg" className="w-100 img-fluid" alt="" />
            <div className="categori-card-child">
        ...
        <a href="#">
          ...
          <div className="categori-card categori-card-full">
            <img src="https://cdn.aksesuarix.com/Fotograflar/89963-aaaaa.jpg" className="w-100 img-fluid" alt="" />
            <div className="categori-card-child">
              <div className="categori-p2">Havluda ikinci ürüne</div>
              <p className="categori-baslik">%50 indirim</p>
              <button className="categori-hemen-kesfet-full">Hemen Keşfet</button>
            </div>
          </div>
          </a>
