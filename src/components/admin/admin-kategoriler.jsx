...
const Admin_kategoriler = () => {
  ...
  const indexOfLastCategory2 = currentPage2 * categoriesPerPage2;
  const indexOfFirstCategory2 = indexOfLastCategory2 - categoriesPerPage2;
  const currentCategories2 = slidercategoriesData.slice(indexOfFirstCategory2, indexOfLastCategory2);

  const totalPages2 = Math.ceil(categoriesData.length / categoriesPerPage);

  const handleClick2 = (event, pageNumber2) => {
    event.preventDefault();
  ...
  return (
    <div>
      ...
      <div className="admin-sag-container">
        ...
        <div className="row admin-genel-row">
          <div className="col-12 alt-basliklar-admin">Slider Kategori Listesi</div>
          <div className="col-12 mt-5">
            <div className="table-responsive">
            <table className="table">
                <thead>
                ...
                <tbody>
                  {currentCategories2.map(category => (
                    <tr key={category.id}>
                      <th scope="row">{category.id}</th>
                      <td><img src={category.image} className="img-fluid urunler-listesi-img" alt={category.name} /></td>
                      <td>{category.name}</td>
              ...
              <nav aria-label="Page navigation example" className="col-5">
                  <ul className="pagination">
                    <li className={`page-item ${currentPage2 === 1 ? 'disabled' : ''}`}>
                      <a className="page-link" href="#" aria-label="Previous" onClick={(e) => handleClick2(e, currentPage2 - 1)}>
                        <span aria-hidden="true">&laquo;</span>
                      </a>
                    </li>
                    {[...Array(totalPages2)].map((_, index) => (
                      <li key={index} className={`page-item ${currentPage2 === index + 1 ? 'active' : ''}`}>
                        <a className="page-link" href="#" onClick={(e) => handleClick2(e, index + 1)}>{index + 1}</a>
                      </li>
                    ))}
                    <li className={`page-item ${currentPage2 === totalPages2 ? 'disabled' : ''}`}>
                      <a className="page-link" href="#" aria-label="Next" onClick={(e) => handleClick2(e, currentPage2 + 1)}>
                        <span aria-hidden="true">&raquo;</span>
                      </a>
                    </li>
                  </ul>
          ...
          <div className="popup-overlay">
            <div className="popup-content">
              ...
              <div>
                ...
                <button type="submit">Kategoriyi Ekle</button>
              </form>
            </div>
          </div>
        )}
