...
const ProductQuestions = ({ productId }) => {
    ...
    const SendQuestion = async () => {
        ...
        const res = await PostProductQuestionRequest(body);
    ...
    return (
        <div className="d-flex flex-column gap-3">
            ...
            <div className="d-flex align-items-center flex-wrap gap-2">
                ...
                {questions.map((q) => (
                    <div key={q.id} className="card p-3 mb-2 shadow-sm">
                        ...
                        {q.answer ? (
                            <p className="text-success small">Cevap: {q.answer}</p>
                        ) : (
            ...
            <div className="d-flex gap-2 justify-content-center">
                {pageNum > 1 &&
                    <button className="btn pag-btn d-flex justify-content-center align-items-center" onClick={() => setPageNum(pageNum - 1)}>
